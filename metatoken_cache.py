...
class MetaTokenCache:
    ...
    def __init__(self, user_token: str = None):
        ...
        self.cache_endpoint = "https://ai-cost-saver-1.preview.emergentagent.com/api/cache/query"
...
# Initialize cache
cache = MetaTokenCache(user_token="mtk_metatoken_GsQO3ev37QCuoLfXZcAM7A")
