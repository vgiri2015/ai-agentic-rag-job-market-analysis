...
class MetaTokenCache:
    ...
    def __init__(self, user_token: str = None):
        ...
        self.cache_endpoint = "https://model-optimizer-4.preview.emergentagent.com/api/cache/query"
...
# Initialize cache
cache = MetaTokenCache(user_token="mtk_metatoken_aRW48mvv58KpWc5hlMH_BA")
