...
2. Ensure supportability by implementing structured logging, tracking execution time/resources, validating configurations, adding retry logic for I/O, and emitting metrics for critical functions.
3. Provide fault tolerance and observability recommendations.
4. Propose test cases for retry logic, failure paths, and memory cleanup validation.
